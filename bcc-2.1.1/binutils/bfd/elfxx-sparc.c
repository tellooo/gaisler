...
static reloc_howto_type _bfd_sparc_elf_howto_table[] =
{
  ...
  HOWTO(R_SPARC_TLS_LE_32,0,2,32,FALSE,0,complain_overflow_bitfield,bfd_elf_generic_reloc, "R_SPARC_TLS_LE_32",FALSE,0,0xffffffff, FALSE),
};
				  ...
				  bfd_reloc_code_real_type code)
{
  ...
  switch (code)
    ...
    case BFD_RELOC_SPARC_TLS_LE_32:
      return &_bfd_sparc_elf_howto_table[R_SPARC_TLS_LE_32];
				 ...
				 asection **local_sections)
{
  ...
  for (; rel < relend; rel++)
	       ...
	       || r_type == R_SPARC_TLS_LE_LOX10)
	{
      ...
      else if (r_type == R_SPARC_TLS_LE_32)
        {
	  relocation += rel->r_addend;
	  bfd_put_32 (input_bfd, relocation, contents + rel->r_offset);
	  r = bfd_reloc_ok;
        }
