...
#define HAVE_AS_DEBUG_CANONICAL_PATH
#ifdef HAVE_AS_DEBUG_CANONICAL_PATH
#define ASM_DBG_CANONICAL " %{fdebug-canonical-path:--debug-canonical-path}"
#else
#define ASM_DBG_CANONICAL
#endif

#define ASM_COMMON ASM_MAP ASM_DBG_CANONICAL
...
#  define ASM_DEBUG_SPEC						\
      (PREFERRED_DEBUGGING_TYPE == DBX_DEBUG				\
       ? "%{%:debug-level-gt(0):"					\
	 "%{gdwarf*:--gdwarf2}%{!gdwarf*:%{g*:--gstabs}}}" ASM_COMMON	\
       : "%{%:debug-level-gt(0):"					\
	 "%{gstabs*:--gstabs}%{!gstabs*:%{g*:--gdwarf2}}}" ASM_COMMON)
# else
#  if defined(DBX_DEBUGGING_INFO) && defined(HAVE_AS_GSTABS_DEBUG_FLAG)
#   define ASM_DEBUG_SPEC "%{g*:%{%:debug-level-gt(0):--gstabs}}" ASM_COMMON
#  endif
#  if defined(DWARF2_DEBUGGING_INFO) && defined(HAVE_AS_GDWARF2_DEBUG_FLAG)
#   define ASM_DEBUG_SPEC "%{g*:%{%:debug-level-gt(0):--gdwarf2}}" ASM_COMMON
#  endif
# endif
#endif
#ifndef ASM_DEBUG_SPEC
