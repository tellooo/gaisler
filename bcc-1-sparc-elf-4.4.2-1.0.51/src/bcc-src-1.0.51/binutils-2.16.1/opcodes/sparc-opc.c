...
{ "umac",	F3(2, 0x3e, 0), F3(~2, ~0x3e, ~0)|ASI(~0),	"1,2,d", 0, v8 },
{ "umac",	F3(2, 0x3e, 1), F3(~2, ~0x3e, ~1),		"1,i,d", 0, v8 },
{ "umac",	F3(2, 0x3e, 1), F3(~2, ~0x3e, ~1),		"i,1,d", 0, v8 },
{ "smac",	F3(2, 0x3f, 0), F3(~2, ~0x3f, ~0)|ASI(~0),	"1,2,d", 0, v8 },
{ "smac",	F3(2, 0x3f, 1), F3(~2, ~0x3f, ~1),		"1,i,d", 0, v8 },
{ "smac",	F3(2, 0x3f, 1), F3(~2, ~0x3f, ~1),		"i,1,d", 0, v8 },
...
{ "casa",	F3(3, 0x3c, 0), F3(~3, ~0x3c, ~0), "[1]A,2,d", 0, sparcleon }, 
{ "casa",	F3(3, 0x3c, 1), F3(~3, ~0x3c, ~1), "[1]o,2,d", 0, sparcleon },
...
{ "cas",	F3(3, 0x3c, 0)|ASI(0x80), F3(~3, ~0x3c, ~0)|ASI(~0x80), "[1],2,d", F_ALIAS, sparcleon }, /* casa [rs1]ASI_P,rs2,rd */
{ "casl",	F3(3, 0x3c, 0)|ASI(0x88), F3(~3, ~0x3c, ~0)|ASI(~0x88), "[1],2,d", F_ALIAS, sparcleon }, /* casa [rs1]ASI_P_L,rs2,rd */
