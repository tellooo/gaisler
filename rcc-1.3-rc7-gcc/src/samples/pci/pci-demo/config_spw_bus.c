...
struct drvmgr_key ambapp_rmap_grlib1_mctrl0_res[] =
{
	 ...
	 * PART0 = 2MBytes SRAM
	 */
	{"part0Start",  DRVMGR_KT_INT, {(unsigned int) 0x40000000}}, /* Use 2Mb SRAM to ambapp_rmap_partition_memalign() */
	{"part0Length", DRVMGR_KT_INT, {(unsigned int) 0x00200000}},

	/* WASH RAM settings */
	{"wash1Start",  DRVMGR_KT_INT, {(unsigned int) 0x40000000}}, /* 4Mb SRAM (wash is not limited to partition size) */
	{"wash1Length", DRVMGR_KT_INT, {(unsigned int) 0x00400000}}, /* Wash the SRAM memory (after EDAC is enabled) */
	DRVMGR_KEY_EMPTY
};
 ...
 */
struct drvmgr_key ambapp_rmap_grlib1_grtm0_res[] =
{
	/* MAX Frame Length, used to allocate buffers. */
	{"maxFrameLength", DRVMGR_KT_INT, {(unsigned int) 1120}}, /* 1115 Framelength */

	/* Allocate BD descriptor table from Memory Partition 1 (SRAM: see MCTRL config) */
	{"bdAllocPartition", DRVMGR_KT_INT, {(unsigned int) 0}},

	/* Allocate Frame Buffers from Memory Partition 1 (SRAM: see MCTRL config) */
	{"frameAllocPartition", DRVMGR_KT_INT, {(unsigned int) 0}}, 
	DRVMGR_KEY_EMPTY
};

/* All Driver resources on the GR-TMTC02 AMBA bus */
struct drvmgr_drv_res ambapp_rmap_grlib0_res[] =
{
...
struct drvmgr_key spw_bus0_grlib1_res[] = 
{
	{"IOArea", DRVMGR_KT_INT, {(unsigned int)0x80200000}},
	{"BusFreq", DRVMGR_KT_INT, {(unsigned int)33000000}}, /* Clocked taken from PCI clock */
	{"BusRes", DRVMGR_KT_POINTER,{(unsigned int)&ambapp_rmap_grlib1_res[0]}},
	DRVMGR_KEY_EMPTY
};

/* GR-TMTC0 SpW Node hardware set up. */
struct drvmgr_key gr_tmtc_spw_target[] =
{
	{"DST_ADR", DRVMGR_KT_INT, 0xFE},
	{"DST_KEY", DRVMGR_KT_INT, 0},
	{"VIRQ1", DRVMGR_KT_INT, SPWBUS_VIRQ1}, /* Virtual IRQ index=1 of this SpW-Node, is connected to Virtual IRQ 1 */
	DRVMGR_KEY_EMPTY
};
#endif
...
struct drvmgr_key spw_bus0_grlib2_res[] = 
{
	{"IOArea", DRVMGR_KT_INT, {(unsigned int)0x80100000}},
	{"BusFreq", DRVMGR_KT_INT, {(unsigned int)50000000}},
	DRVMGR_KEY_EMPTY
};

/* GR-IO0 SpW Node hardware set up. */
struct drvmgr_key gr_io_spw_target[] =
{
	{"DST_ADR", DRVMGR_KT_INT, 0xFE},
	{"DST_KEY", DRVMGR_KT_INT, 0},
	{"VIRQ1", DRVMGR_KT_INT, SPWBUS_VIRQ1}, /* Virtual IRQ index=1 of this SpW-Node, is connected to Virtual IRQ 1 */
 ...
 */
struct drvmgr_drv_res spw_bus0_resources[] =
{
#ifdef GR_RASTA_TMTC_RMAP
