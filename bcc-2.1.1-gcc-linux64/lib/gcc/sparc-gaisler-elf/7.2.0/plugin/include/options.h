...
enum opt_code
{
  ...
  OPT_Wprio_ctor_dtor = 330,                 /* -Wprio-ctor-dtor */
  ...
  OPT_fdce = 568,                            /* -fdce */
  OPT_fdebug_canonical_path = 569,           /* -fdebug-canonical-path */
  ...
  OPT_m32 = 1152,                            /* -m32 */
  OPT_m64 = 1153,                            /* -m64 */
  OPT_mapp_regs = 1154,                      /* -mapp-regs */
  OPT_mcbcond = 1155,                        /* -mcbcond */
  OPT_mcmodel_ = 1156,                       /* -mcmodel= */
  OPT_mcpu_ = 1157,                          /* -mcpu= */
  OPT_mdebug_ = 1158,                        /* -mdebug= */
  OPT_mfaster_structs = 1159,                /* -mfaster-structs */
  OPT_mfix_at697f = 1160,                    /* -mfix-at697f */
  OPT_mfix_b2bst = 1161,                     /* -mfix-b2bst */
  OPT_mfix_gr712rc = 1162,                   /* -mfix-gr712rc */
  OPT_mfix_tn0013 = 1163,                    /* -mfix-tn0013 */
  OPT_mfix_ut699 = 1164,                     /* -mfix-ut699 */
  OPT_mfix_ut700 = 1165,                     /* -mfix-ut700 */
  OPT_mflat = 1166,                          /* -mflat */
  OPT_mfmaf = 1167,                          /* -mfmaf */
  OPT_mfpu = 1168,                           /* -mfpu */
  OPT_mfsmuld = 1169,                        /* -mfsmuld */
  OPT_mhard_float = 1170,                    /* -mhard-float */
  OPT_mhard_quad_float = 1171,               /* -mhard-quad-float */
  OPT_mlra = 1172,                           /* -mlra */
  OPT_mmemory_model_ = 1173,                 /* -mmemory-model= */
  OPT_mpopc = 1174,                          /* -mpopc */
  OPT_mptr32 = 1175,                         /* -mptr32 */
  OPT_mptr64 = 1176,                         /* -mptr64 */
  OPT_mrelax = 1177,                         /* -mrelax */
  OPT_msoft_float = 1178,                    /* -msoft-float */
  OPT_msoft_quad_float = 1179,               /* -msoft-quad-float */
  OPT_mstack_bias = 1180,                    /* -mstack-bias */
  OPT_mstd_struct_return = 1181,             /* -mstd-struct-return */
  OPT_msubxc = 1182,                         /* -msubxc */
  OPT_mtune_ = 1183,                         /* -mtune= */
  OPT_munaligned_doubles = 1184,             /* -munaligned-doubles */
  OPT_muser_mode = 1185,                     /* -muser-mode */
  OPT_mv8plus = 1186,                        /* -mv8plus */
  OPT_mvis = 1187,                           /* -mvis */
  OPT_mvis2 = 1188,                          /* -mvis2 */
  OPT_mvis3 = 1189,                          /* -mvis3 */
  OPT_mvis4 = 1190,                          /* -mvis4 */
  OPT_mvis4b = 1191,                         /* -mvis4b */
  OPT_n = 1192,                              /* -n */
  OPT_no_canonical_prefixes = 1193,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1194,              /* -no-integrated-cpp */
  OPT_no_pie = 1195,                         /* -no-pie */
  OPT_nocpp = 1196,                          /* -nocpp */
  OPT_nodefaultlibs = 1197,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1198,                   /* -nostartfiles */
  OPT_nostdinc = 1199,                       /* -nostdinc */
  OPT_nostdinc__ = 1200,                     /* -nostdinc++ */
  OPT_nostdlib = 1201,                       /* -nostdlib */
  OPT_o = 1202,                              /* -o */
  OPT_p = 1203,                              /* -p */
  ...
  OPT_qfix_tn0018 = 1221,                    /* -qfix-tn0018 */
  OPT_qnano = 1222,                          /* -qnano */
  OPT_qsvt = 1223,                           /* -qsvt */
  OPT_quiet = 1224,                          /* -quiet */
  OPT_r = 1225,                              /* -r */
