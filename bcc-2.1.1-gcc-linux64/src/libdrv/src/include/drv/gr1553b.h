...
typedef struct gr1553_devcfg *GR1553B;
 ...
 */
extern int gr1553_dev_count(void);

/* Register GR1553B driver */
extern void gr1553_register(struct gr1553_devcfg *dev);
extern void gr1553_unregister(struct gr1553_devcfg *dev);

/* Register an array of devices */
extern int gr1553_init(struct gr1553_devcfg *devcfgs[]);
extern int gr1553_autoinit(void);

/*** BC Device allocation ***/
/* Allocate a BC device. Minor is assigned to a device in the order
 * they are registered to the driver.
 */
extern GR1553B gr1553_bc_open(int minor);
/* Free a BC device previously allocated */
extern void gr1553_bc_close(GR1553B dev);
/* Set/get private pointer */
 ...
 * they are registered to the driver.
 */
extern GR1553B gr1553_rt_open(int minor);
/* Free a BC device previously allocated */
extern void gr1553_rt_close(GR1553B dev);
/* Set/get private pointer */
 ...
 * they are registered to the driver.
 */
extern GR1553B gr1553_bm_open(int minor);
/* Free a BC device previously allocated */
extern void gr1553_bm_close(GR1553B dev);
/* Set/get private pointer */
void *gr1553_bm_get(GR1553B dev);

extern void gr1553b_fatal_error(int error) __attribute__((weak));
