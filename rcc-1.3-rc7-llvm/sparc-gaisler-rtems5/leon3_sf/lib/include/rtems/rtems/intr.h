 ...
 * @see rtems_interrupt_lock_release_isr().
 */
#define rtems_interrupt_lock_acquire_isr_inline( _lock, _lock_context ) \
  _ISR_lock_Acquire_inline( _lock, _lock_context )
 ...
 * @see rtems_interrupt_lock_acquire_isr().
 */
#define rtems_interrupt_lock_release_isr_inline( _lock, _lock_context ) \
  _ISR_lock_Release_inline( _lock, _lock_context )
