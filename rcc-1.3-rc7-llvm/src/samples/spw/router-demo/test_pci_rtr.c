 ...
 * over PCI and SpaceWire through two routers.
 *
 ...
 * follows:
 *
 *  AMBAPort0 TX              ->  SpW0  ->  PCI-BOARD AMBA Port 0 RX
 *  PCI-BOARD AMBA Port 0 TX  ->  SpW0  ->  SpW1  -> PCI-BOARD AMBA Port 1 RX
 *  PCI-BOARD AMBA Port 1 TX  ->  SpW1  -> AMBAPort1 RX
 *  AMBAPort1 TX              ->  SpW2  -> PCI-BOARD AMBA Port 2 RX
 *  PCI-BOARD AMBA Port 2 TX  ->  SpW2  -> AMBAPort0 RX
 *
 ...
 *  on-chip (router) SpW0 port <-> PCI-BOARD router SpW0
 *  on-chip (router) SpW1 port <-> PCI-BOARD router SpW1
 *  on-chip (router) SpW2 port <-> PCI-BOARD router SpW2
 *
 * Device SpaceWire node ID:
 *  on-chip AMBA port0      - 0x1
 *  on-chip AMBA port1      - 0x2
 *  PCI-BOARD router AMBA/SpW port0 - 0x10
 *  PCI-BOARD router AMBA/SpW port1 - 0x11
 *  PCI-BOARD router AMBA/SpW port2 - 0x12
 *
...
#define PCI_ROUTER_SPWLINK_NO 8
#define ROUTER_AMBA_PORTS 4
#define PCI_ROUTER_AMBA_PORTS 4
...
#define CONFIGURE_DRIVER_PCI_GR_LEON4_N2X       /* GR-CPCI-LEON4-N2X PCI Target Driver */
...
{
	.dstadr_next = 0x11,
	.dstadr = {0x1, PCI_ROUTER_SPWLINK_NO+1, 0x10, 0},
};
...
struct route_entry routetab[ROUTE_MAX] = 
{
	...
	/* 0x00 */ {0, {0, 0}},
	/* 0x01 */ {0x10, {0x2, 1+ROUTER_SPWLINK_NO, 0x1, 0}},
	/* 0x02 */ {0x12, {0x1, 1+ROUTER_SPWLINK_NO+1, 0x2, 0}},
	/* 0x03 */ {0, {0}},
	/* 0x04 */ {0, {0}},
	/* 0x05 */ {0, {0}},
	/* 0x06 */ {0, {0}},
	...
	/* 0x0e */ {0, {0}},
	/* 0x0f */ {0, {0}},
	/* 0x10 PCI-BOARD AMBA 0 */ {0x11, {0x1, PCI_ROUTER_SPWLINK_NO+1, 0x10, 0}},
	/* 0x11 PCI-BOARD AMBA 1 */ {0x2, {0x1, 0x2, PCI_ROUTER_SPWLINK_NO+2, 0x11, 0}},
	/* 0x12 PCI-BOARD AMBA 2 */ {0x1, {0x3, PCI_ROUTER_SPWLINK_NO+3, 0x12, 0}},
};
